# Vendored verbatim from turboderp-org/exllamav3 (MIT), eval/model_diff.py at
# commit c18e9b40bed1d2bd9c30fbbc0ba0eeb19b4fbda1 — the same exllamav3 the pod
# runs. pip installs only the exllamav3/ package, not this top-level script, so
# we ship it next to quant.py for the post-quant KL-divergence eval. Keep in
# sync when bumping the pinned exllamav3 ref.
import sys, os
