...
# Qwen3.5-4B — 8 bpw EXL3

This model is an [**EXL3**](https://github.com/turboderp-org/exllamav3)-quantized build of **[Qwen/Qwen3.5-4B](https://huggingface.co/Qwen/Qwen3.5-4B)**, produced for GPU inference with **ExLlamaV3**.
...
| **Bits per weight** | 8 |
| **This repo** | [blockblockblock/Qwen3.5-4B-8bpw-exl3](https://huggingface.co/blockblockblock/Qwen3.5-4B-8bpw-exl3) |
